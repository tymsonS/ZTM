...
print('Ala ma kota, byle byl commit-l')
print('Dodaje by cos nie gralo-k')
print('Aby byl nowy commit-a')
print('Aby byl nowy commit 1a')
print('Aby byl nowy commit 2b')
print('Aby byl nowy commit 3c')
print('Aby byl nowy commit 4d')
